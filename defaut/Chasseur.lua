...
Define(barrage 120360)
  SpellInfo(barrage duration=3 cd=30 )
...
Define(explosive_trap 13813)
  SpellInfo(explosive_trap duration=60 cd=30 )
...
Define(kill_shot 90967)
  SpellInfo(kill_shot duration=6 )
