...
Define(divine_insight_shadow 14430)
...
Define(mind_blast 8092)
  SpellInfo(mind_blast casttime=1.5 shadoworbs=-1 cd=8 )
Define(mind_flay 15407)
  SpellInfo(mind_flay casttime=3 tick=1 )
  SpellAddTargetDebuff(mind_flay mind_flay=1)
Define(mind_sear 48045)
  SpellInfo(mind_sear casttime=5 tick=1 )
...
Define(shadow_word_death 32379)
  SpellInfo(shadow_word_death shadoworbs=1 cd=8 )
