...
Define(bloodthirst 23881)
  SpellInfo(bloodthirst mana=-10 cd=4.5 )
...
Define(heroic_strike 78)
  SpellInfo(heroic_strike mana=30 cd=1.5 )
...
Define(mortal_strike 12294)
  SpellInfo(mortal_strike mana=-10 cd=6 )
