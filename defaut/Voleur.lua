...
Define(dispatch 111240)
  SpellInfo(dispatch combo=1 )
Define(envenom 32645)
  SpellInfo(envenom duration=1 combo=0 )
  SpellAddBuff(envenom envenom=1)
Define(eviscerate 2098)
  SpellInfo(eviscerate combo=0 )
...
Define(revealing_strike 84617)
  SpellInfo(revealing_strike duration=18 combo=1 )
  SpellAddBuff(revealing_strike revealing_strike=1)
Define(rupture 1943)
  SpellInfo(rupture duration=4 combo=0 )
...
Define(sinister_strike 1752)
  SpellInfo(sinister_strike combo=0 )
Define(slice_and_dice 5171)
  SpellInfo(slice_and_dice duration=6 combo=0 )
